		...
		<div class="layui-col-md6" style="width:80%;">
			<div class="layui-card" id="md6">
				<div id="title" class="layui-card-header">
					...
					<img src="<%=request.getContextPath()%>/headphoto/<%=DaoFactory.getUserDao().getByUserName(biaobai3.getUsername()).getHeadphoto()%>" width="45" height="45"/></div><!-- 头像 -->
					<!--  -->
					<div style="height:45px;padding:10px;"><%=biaobai3.getUsername()%></div>
				</div>
				<div class="layui-card-body">
					我舍友是<b><%=biaobai3.getDepartment()%></b>的一个<%=biaobai3.getGender()%><br>
					<%=biaobai3.getContentwithouthtml()%><br>
					<a
						href="<%=request.getContextPath()%>/biaobai/biaobai3Show.jsp?id=<%=biaobai3.getId()%>"
						style="float: right">
					...
					<div style="margin: 0px 5px 5px 5px;">
						<%
					if(biaobai3.getImgUrl()!=null&&!"".equals(biaobai3.getImgUrl().trim()))
						for(String photos:biaobai3.getImgUrl().split(",")){
