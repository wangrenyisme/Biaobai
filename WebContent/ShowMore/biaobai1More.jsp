		...
		<div class="layui-col-md6" style="width:80%;">
			<div class="layui-card" id="md6">
				...
				<div style="width:45px;height:45px;border-radius:100%;overflow:hidden;float:left;">
					<img src="<%=request.getContextPath()%>/headphoto/<%=DaoFactory.getUserDao().getByUserName(biaobai1.getUsername()).getHeadphoto()%>" width="45" height="45"/></div><!-- 头像 -->
					<!-- 头像 -->
					<div style="height:45px;padding:10px;"><%=biaobai1.getUsername()%></div><!--  -->
				</div>
				
				<div class="layui-card-body">
					<b>我要表白:</b><%=biaobai1.getDepartment()%>的 <a href=""> <%=biaobai1.getLovename()%></a>
					<%=biaobai1.getGender()%><br> 
					<b>我想说:</b><%=biaobai1.getContentwithouthtml()%><br>
					<a
