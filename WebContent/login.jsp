...
<body>
	...
	<div class="banner">
						...
						<input
							...
							<div id="check-code" style="float:left">
								<div class="code" id="data_code">
									<input type="button" id="yanzhengma" style="color: blue; font-size: 16px; width:125px;height: 40px;" name="yanzhengma" onclick="change()" value="点击获取" />
									<input type="hidden" id="text_yzm" name="text_yzm" value=" " />
								</div>
							</div>
					</div>
					<div class="fm-item">
		...
		<div class="bd">
			<ul>
				<li
					style="background: url(<%=request.getContextPath()%>/images/theme-pic1.jpg) #FFFFFF center 0 no-repeat;"><a
					target="_blank"></a></li>
				<li
					style="background: url(<%=request.getContextPath()%>/images/theme-pic2.jpg) #FFFFFF center 0 no-repeat;"><a
					target="_blank"></a></li>
			</ul>
		</div>
		<div class="hd">
