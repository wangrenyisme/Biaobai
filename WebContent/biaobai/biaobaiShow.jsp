...
<frameset rows="12%,*,5%" frameborder="no" border="0" framespacing="0"  >
  ...
  <frameset cols="20%,80%" frameborder="no" border="0" framespacing="0"  >
  	<frame src="../left.jsp"  name="leftFrame" marginWidth=0 marginHeight=0 src="" noResize scrolling="yes"/>
  	<frame src="biaobai<%=Integer.parseInt(request.getParameter("type")) %>Show.jsp?id=<%=Integer.parseInt(request.getParameter("id")) %>" name="mainFrame" id="mainFrame" title="mainFrame"  marginWidth="0" marginHeight="0" />
  </frameset>
